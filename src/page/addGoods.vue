  ...
  <div class="add-goods">
    <head-top></head-top>
      ...
      <el-col :span="14" :offset="4">
        ...
        <el-row class="add-category-row" :class="showAddCategory ? 'show-edit' : ''">
          <div class="add-category">
            ...
            <el-form-item>
              <el-button @click="submitcategoryForm('categoryForm')" type="primary">提交</el-button>
            </el-form-item>
          </div>
        </el-row>
        <div class="add-category-button" @click="addCategoryFun">
          <i class="el-icon-caret-top edit-icon" v-if="showAddCategory"></i>
          <i class="el-icon-caret-bottom edit-icon" v-else slot="icon"></i>
          <span>添加食品种类</span>
        </div>
        </el-form>
